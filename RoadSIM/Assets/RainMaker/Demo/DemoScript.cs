...
using AmazingAssets.RenderMonster;
...
namespace DigitalRuby.RainMaker
{
    public class DemoScript : MonoBehaviour
    {
        ...
        public void RainSliderChanged()
        {
            var val = RainSlider.value;
            if (val > 0.2)
            {
                rm.prompt = "vibrant road, traffic, environment, indian roads, best quality, ultra high res, photorealistic, realistic weather, rain, realistic vehicles, accurate backgrounds, high definition backgrounds, Clear roads, 8k vehicle";
            }
            else
            {
                rm.prompt = "vibrant road, traffic, environment, indian roads, best quality, ultra high res, photorealistic, realistic weather, sunny, dry roads realistic vehicles, accurate backgrounds, high definition backgrounds, Clear roads, 8k vehicle";
            }
        ...
        public void DawnDuskSliderChanged()
        {
            var val = DawnDuskSlider.value;
            if (val < -30.0)
            {
                rm.prompt += "night time, tail lights, glow";
            }
            else
            {
                rm.prompt += "morning time, sunny weather";
            }
        ...
        private void Start()
        {
            ...
            //RainScript.RainIntensity = RainSlider.value = 0.0f;
